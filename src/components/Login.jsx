    ...
    <div className='flex justify-center items-center h-[90vh] w-screen gap-6 lg:gap-12 xl:gap-20'>
      ...
      <div className='w-[40vw] h-[80vh] md:h-[70vh] lg:h-[60vh]'>
        <div className='flex flex-col justify-center items-center h-full'>
          <div className='ml-4 font-semibold font-janime tracking-widest text-brown text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center mb-8'>LOGIN</div>
          ...
          <form action="submit " className='flex flex-col items-center gap-2'>
            ...
            <div className='ml-4 flex flex-col gap-4 items-center mt-2 md:mt-4'>
              ...
              <div onClick={submit} className='bg-brown hover:scale-105 cursor-pointer transition-all hover:bg-lightBrown  mx-2 rounded-2xl px-4 py-2 text-white font-bold mt-4'>LOGIN</div>
            </div>
