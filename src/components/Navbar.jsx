        ...
        <div className="flex overflow-x-hidden">
            ...
            <div className='flex overflow-hidden absolute right-0'>
                <div className='group flex transition-all justify-end items-start translate-x-1/2 -translate-y-1/2'>
                    <div className=" w-[256px] h-[256px] bg-yellow-200 relative rounded-full group-hover:rotate-[-90deg] transition-all duration-300 flex justify-center items-center ">
