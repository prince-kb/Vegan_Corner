...
const Navbar = () => {
    ...
    return (
        <div className="flex select-none">
            ...
            <div className='flex absolute right-0 h-[150%]'>
                <div className='group flex transition-all justify-end items-start translate-x-1/2 -translate-y-[9%]' onClick={rotate}>
                    <div className=" w-[256px] h-[256px] bg-yellow-200 relative rounded-full md:group-hover:rotate-[-90deg] transition-all duration-300 flex justify-center items-center " ref={ref}>
                        ...
                        <div className="flex-center rounded-full absolute w-[48px] h-[48px] bg-brown left-[12px]   top-[-30px] hover:scale-150 transition-all group/3"  onClick={rotate1}>
                            <h2 className='bg-brown text-white font-bold text-sm px-2 py-1 rotate-90 rounded-2xl absolute -translate-y-[120%] hidden group-hover/3:block'>Quick food</h2>                        
