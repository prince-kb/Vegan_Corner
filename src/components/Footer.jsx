  ...
  return (
    <div>
        <footer className="text-gray-800 text-center w-full flex-center flex-col mt-4 mb-8">
            ...
            <h3 className='font-semibold tracking-wide smalltext mt-2'>For any complain/suggestion <Link to="https://princekb.me/contact" target='_blank' className='underline hover:text-gray-500'>VISIT ME</Link></h3>
        </footer>
