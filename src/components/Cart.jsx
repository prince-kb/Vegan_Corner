      ...
      {user?.cart?.length > 0 && (
        <div >
          ...
          <div className="flex flex-col justify-center gap-2 mt-8 mb-4">
            ...
            <button className="bg-green-600 text-gray-100 font-bold font-cav tracking-tight text-xl md:text-2xl min-w-1/2 rounded-2xl px-2 py-1 md:px-6 md:py-4 max-w-[400px] mx-auto active:ring-4 hover:bg-green-700 transition-colors" onClick={placeOrder}>PROCEED TO CHECKOUT {"->"} </button>
          </div>
        </div>
      )}
    </div>
