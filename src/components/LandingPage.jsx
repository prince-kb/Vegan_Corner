  ...
  return (
    <div className="pageheight mb-16" ref={ref}>
      ...
      <div
        ...
        className={`bannerss relative z-[2] mx-auto mt-4 flex h-[42vw] w-[84vw] md:h-[30vw] md:w-[60vw] lg:w-[44vw] lg:h-[22vw] xl:h-[18vw] xl:w-[36vw] mb-32 items-end justify-center rounded-3xl bg-green-200 lg:mt-8 lg:rounded-3xl`}
      >
        {banners &&
          banners.length > 0 &&
          banners.map((b, index) => (
