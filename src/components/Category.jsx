    ...
    return (
        ...
        <div className={`m-4 lg:m-8 mt-12`} >
            ...
            <div className={`flex gap-4 overflow-auto pl-2 lg:pl-6`}>
                {all.map((item, i) => (
                    <div onClick={() => {props.type === "type" && scrollTo(0, 0); navigate(`/product/${item.id}`)}} key={i} className="cursor-pointer relative mx-auto mb-4 min-w-[160px] md:min-w-[200px] lg:min-w-[240px] hover:neu2 border rounded-2xl transition-all shadow-lg flex flex-col items-center justify-around">
                        {/* Priority Part */}
